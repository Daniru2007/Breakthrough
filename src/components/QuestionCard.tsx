...
export default function QuestionCard({ 
  ...
  useEffect(() => {
    ...
    if (cooldown > 0) {
      ...
      onSelectAnswer(''); // Reset the selected answer
    }
    return () => clearInterval(timer);
  }, [cooldown, isInCooldown, onSelectAnswer]);
          ...
          {options.map((option, index) => {
            ...
            return (
              <button
                ...
                disabled={!!selectedAnswer || isInCooldown}
        ...
        {showNextButton && (
          <div className="mt-6 flex justify-end animate-fade-in">
            <button
              ...
              className="group px-6 py-3 bg-brand text-white rounded-xl font-medium 
